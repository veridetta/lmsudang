    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
             @if ($message = Session::get('success'))
                    ...
                    @endif
            <div class="card">
                <div class="card-header">{{ __('Daftar Pelajaran') }}</div>

                <div class="card-body">
                    <div class="row mt-2 mb-1">
                        <div class="col-lg-12 margin-tb">
                            <div class="float-right">
                                <a class="btn btn-success btn-sm" href="{{ route('admin_academic.create') }}">Tambah Pelajaran</a>
                                <a class="btn btn-primary btn-sm btn-import" href="{{route('admin_academic.import')}}">Import Pelajaran</a>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
  $(function () {
    var table = $('.sc_all').DataTable({
        ...
        ajax: "{{ route('admin_academic.getAll') }}",
        columns: [
