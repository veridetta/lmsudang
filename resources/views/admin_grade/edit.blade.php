                ...
                <div class="col-md-6 col-12">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin_grade.update',$grades->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{ $grades->name }}" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <strong>Kode Kelas:</strong>
                                            <input type="text" name="code" value="{{ $grades->code }}" class="form-control" >
                                        </div>
                                    </div>
