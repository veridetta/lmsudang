                    ...
                    <div class="row mt-2 mb-1">
                        <div class="col-lg-12 margin-tb">
                            <div class="float-right">
                                <a class="btn btn-success btn-sm" href="{{ route('admin_student.create') }}">Tambah Siswa</a>
                                <a class="btn btn-primary btn-sm btn-import" href="{{route('admin_student.import')}}">Import Siswa</a>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
  $(function () {
    var table = $('.sc_all').DataTable({
        ...
        ajax: "{{ route('admin_student.getAll') }}",
        columns: [
