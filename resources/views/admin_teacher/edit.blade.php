        ...
        <div class="row mt-5">
            <div class="row col-12 justify-content-center">
                <div class="col-md-6 col-12">
                    <div class="card ">
                        <div class="card-header">{{ __('Ubah Pengajar') }}</div>
                        @if ($errors->any())
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin_teacher.update',$teachers->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <div class="form-group">
                                            <strong>NIP:</strong>
                                            <input type="number" name="nip" value="{{ $teachers->nip }}" class="form-control" >
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <strong>Mapel:</strong>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" class="form-control">{{$teachers->address}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>Telp:</strong>
                                            <input type="text" name="hp" class="form-control" placeholder="Telp" value="{{ $teachers->hp }}" >
                                        </div>
                                    </div>
                                    </div>
